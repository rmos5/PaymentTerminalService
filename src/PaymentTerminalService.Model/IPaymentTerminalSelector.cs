...
namespace PaymentTerminalService.Model
{
    ...
    public interface IPaymentTerminalSelector
    {
        ...
        /// <summary>
        /// Deselects the currently selected terminal, deactivating its implementation and releasing resources (e.g., serial ports).
        /// </summary>
        /// <param name="cancellationToken">Token to cancel the operation.</param>
        /// <returns>
        /// A <see cref="OperationAccepted"/> indicating the deselection operation was accepted.
        /// </returns>
        Task<OperationAccepted> DeselectTerminalAsync(CancellationToken cancellationToken = default);
    }
}