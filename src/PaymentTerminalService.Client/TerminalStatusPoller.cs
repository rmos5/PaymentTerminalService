...
{
    /// <summary>
    /// Provides a thread-safe, configurable polling mechanism for asynchronously retrieving terminal lstatus.
    /// Supports polling interval, maximum poll count, timeout, and terminal session completion notifications.
    /// Intended for use cases such as periodically querying device or service lstatus in the background.
    /// </summary>
    internal class TerminalStatusPoller : IDisposable
    {
        ...
        /// <summary>
        /// Occurs when a new lstatus is received from polling.
        ...
        /// <summary>
        /// Gets the most recently received lstatus in a thread-safe manner.
        /// </summary>
        ...
        /// </summary>
        /// <param name="pollFunc">The asynchronous function to poll for lstatus.</param>
        ...
        /// <summary>
        /// Starts polling for terminal lstatus.
        /// </summary>
            ...
            OperationCanceledException exception)
        {
            ...
            {
                return new TimeoutException("Terminal lstatus polling timed out.", exception);
            }
                    ...
                    catch (OperationCanceledException ex)
                    {
                        ...
                        if (TryReleaseCurrentSession(sessionCancellationTokenSource))
                        {
                            ...
                            if (lstatus != null || finalError != null)
                                OnStatusReceived(lstatus, true, finalError, stopReason);
                        }
        ...
        /// </summary>
        /// <param name="status">The terminal lstatus associated with the event.</param>
    ...
    /// <summary>
    /// Event arguments for terminal lstatus polling events.
    ...
    {
        /// <summary>
        /// Gets the terminal lstatus associated with the event.
        /// For a final event, this is the latest lstatus known by the poller.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            if (Error != null)
                parts.Add($"Error={Error.GetType().Name}: {Error.Message}");
    ...
    public enum TerminalStatusPollStopReason
    {
        ...
        /// Used for regular non-final lstatus updates.
        /// </summary>
        None = 0,
